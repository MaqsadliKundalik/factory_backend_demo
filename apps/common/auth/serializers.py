...
class FactoryUserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = FactoryUser
        fields = ["id", "name", "phone_number", "role", "whouses", "MAIN_PAGE", "PRODUCTS_PAGE", "ORDERS_PAGE", "TRANSPORTS_PAGE", "WHEREHOUSES_PAGE", "CLIENTS_PAGE", "USERS_PAGE", "READY_PRODUCTS_PAGE", "DRIVERS_PAGE", "SUPPLIERS_PAGE", "photo"]
...
class DriverProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Driver
        fields = ["id", "name", "phone_number", "whouse", "role", "photo", "ORDERS_PAGE", "DRIVERS_PAGE"]
