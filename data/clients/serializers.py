...
class ClientSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        representation["photo"] = (
            {"id": instance.photo.id, "file": BASE_URL + instance.photo.file.url}
            if instance.photo
            else None
        )
        representation["branches"] = ClientBranchesSerializer(
            instance.branches, many=True
        ).data
        representation["phone_numbers"] = ClientPhoneSerializer(
