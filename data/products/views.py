...
from .serializers import (
    ...
    SelectWhouseProductSerializer,
    ProductTypeSerializer,
    ProductUnitSerializer,
    ProductSerializer,
    ProductAndItemCreateSerializer,
    WhouseProductsSerializer,
    WhouseProductsHistorySerializer,
...
class WhouseProductsHistoryViewSet(
    DateFilterSchemaMixin, PermissionMetaMixin, ReadOnlyModelViewSet
):
    queryset = WhouseProductsHistory.objects.all()
    serializer_class = WhouseProductsHistorySerializer
    authentication_classes = [UnifiedJWTAuthentication]
    permission_classes = [
        HasDynamicPermission(crud_perm="WHEREHOUSES_PAGE", read_perm="WHEREHOUSES_PAGE")
    ]
    ...
    @swagger_auto_schema(
        manual_parameters=DATE_FILTER_PARAMS + [IS_READY_PRODUCT_PARAM]
    )
...
class ProductItemViewSet(PermissionMetaMixin, ModelViewSet):
    ...
    permission_classes = [
        HasDynamicPermission(
            crud_perm="READY_PRODUCTS_PAGE", read_perm="READY_PRODUCTS_PAGE"
        )
    ]
    pagination_class = StandardResultsSetPagination
    filter_backends = [DjangoFilterBackend, SearchFilter]
